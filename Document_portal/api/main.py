...
from src.doc_analyzer.data_analyser import DocumentAnalyzer
...
@app.post("/compare")
async def compare_documents(file1: UploadFile = File(...), file2: UploadFile = File(...)) -> Any:
    try:
...
async def chat_query(
    ...
    try:
        ...
        raise HTTPException(status_code = 500, detail = f"Querying Failed: {e}")
